        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="section-headline text-center">
              <h2>Tentang Rumah Sasirangan</h2>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/batik/1.jpg" alt="">
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-middle">
              <div class="single-well">
                ...
                <ul>
                  <li>
                    <i class="bi bi-check"></i> informasi tentang Sasirangan
                  </li>
                  <li>
                    <i class="bi bi-check"></i> Macam-macam motif 
                  </li>
                  <li>
                    <i class="bi bi-check"></i> Berita seputar Sasirangan
                  </li>
                  <!-- 
                  <li>
      ...
      <div class="container">
        ...
        <div class="row awesome-project-content portfolio-container">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-app portfolio-item">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Naga Balimbur.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Naga Balimbur.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Naga Balimbur</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Kambang Sakaki2.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Kambang Sakaki2.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Kambang Sakaki</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Hiris Gagatas.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Hiris Gagatas.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Hiris Gagatas</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Gigi Haruan.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Gigi Haruan.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Gigi Haruan</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-app">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Rumah Banjar.jpg" alt="" /></a>
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Rumah Banjar.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Rumah Banjar</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="assets/img/batik/Motif Bayam Raja.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="assets/img/batik/Motif Bayam Raja.jpg">
                      <h4>Sasirangan</h4>
                      <span>Motif Bayam Raja</span>
                    </a>
                  </div>
                </div>
              </div>
