...
<head>
  ...
  <title>Rumah Sasirangan</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{!! asset('user/assets/img/logo/logo2.jpg') !!}" rel="icon">
  <link href="{!! asset('user/assets/img/logo/logo2.jpg') !!}" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Rumah</span>Sasirangan</a></h1>
